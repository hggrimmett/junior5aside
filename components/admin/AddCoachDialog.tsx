...
export default function AddCoachDialog({
  ...
  async function handleSubmit() {
    ...
    setSubmitted(true);
    setSuccessMsg(`Created. Give the coach this password to log in: ${password}`);
    onCreated();
  }
  ...
  return (
    ...
    >
      <DialogContent className="mx-auto max-w-md rounded-2xl p-6 max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="text-base font-black">Add Coach</DialogTitle>
        </DialogHeader>
        ...
        <div className="space-y-3 py-2">
          ...
          <div className="space-y-1">
            ...
            <p className="text-[11px] text-muted-foreground">Share with the coach so they can log in and change it.</p>
          </div>
        ...
        <DialogFooter className="gap-2">
          ...
          >
            {submitted ? "✓ Submitted" : submitting ? "Adding..." : "Add coach"}
          </Button>
        </DialogFooter>
      </DialogContent>
    </Dialog>
